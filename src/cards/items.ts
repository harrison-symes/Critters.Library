...
const items: ICard[] = [
  ...
  // card draw
  {
    ...
    image: "rummager",
    description: "Destroy 2 of your crops to draw 2 cards.",
    type: CARD_TYPE.Item,
  ...
  },
  {
    ...
    image: "morning_tea",
    description: "+ 1 Energy to all of your critters. Draw a card.",
    type: CARD_TYPE.Item,
  ...
  //
  {
    ...
    image: "worm",
    description:
      "Search your deck or discard pile for a seeds card. Shuffle your deck after!",
    type: CARD_TYPE.Item,
...

  {
    ...
    image: "typhoon",
    description:
      "Shuffle a card back into their owner's deck. (Critters, seeds or a card in hand)",
    type: CARD_TYPE.Item,
    tags: [TAGS.EXHAUST],
  },
  {
...

  {
    ...
    image: "rummager",
    description: "Double the effect of the next item you play.",
    type: CARD_TYPE.Item,
    tags: [TAGS.DRAW_2_CARDS, TAGS.CONDITIONAL_SML],
  },
  {
